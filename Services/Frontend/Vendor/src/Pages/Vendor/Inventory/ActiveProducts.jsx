...
import { Search, Filter, Package, AlertCircle, Eye, Edit3, CheckCircle, Activity } from "lucide-react";
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const activeProducts = res.data.filter((product) => product.status?.toLowerCase() === "active");
        ...
        <div className="mb-8">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Active Products</h1>
                <p className="text-gray-600">Manage products that are currently live in your store</p>
              </div>
        ...
        {loading ? (
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-gray-600 font-medium">Loading active products...</p>
            </div>
          </div>
        ) : error ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Active Products</h3>
            <p className="text-gray-600">
              {searchQuery 
                ? "No active products match your search criteria." 
