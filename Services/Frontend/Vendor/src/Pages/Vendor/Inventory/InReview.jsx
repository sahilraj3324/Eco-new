  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const reviewProducts = res.data.filter((product) => product.status?.toLowerCase() === "in review");
        ...
        <div className="mb-8">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Products In Review</h1>
                <p className="text-gray-600">Products currently under review for approval</p>
              </div>
              <div className="mt-4 lg:mt-0">
                <div className="flex items-center space-x-2 text-sm text-gray-500">
                  <FileText className="h-4 w-4" />
                  <span>{filteredProducts.length} Under Review</span>
                </div>
              </div>
            </div>
        ...
        {loading ? (
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-gray-600 font-medium">Loading products under review...</p>
            </div>
          </div>
        ) : error ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Products Under Review</h3>
            <p className="text-gray-600">
              {searchQuery 
                ? "No products under review match your search criteria." 
                : "You don't have any products under review at the moment."}
            </p>
          </div>
        ) : (
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between space-y-4 lg:space-y-0">
                    ...
                    <div className="flex items-center space-x-6 flex-1">
                      <div className="relative">
                        ...
                        />
                        <div className="absolute -top-2 -right-2 bg-yellow-600 text-white text-xs px-2 py-1 rounded-full font-medium">
                          ₹{product.price}
                        </div>
                        <div className="absolute -bottom-2 -left-2 bg-yellow-500 text-white p-1 rounded-full">
