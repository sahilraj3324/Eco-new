...
import { Search, Filter, Package, Clock, AlertCircle, CheckCircle, Truck, XCircle, Ship, Eye, MapPin, Calendar, User, Hash } from "lucide-react";
...
const ReadyToShip = () => {
  ...
  const readyToShipOrders = filteredOrders.filter(order => order.status === "Processed");
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Ready to Ship</h1>
                <p className="text-gray-600">Manage orders that are processed and ready for shipment</p>
              </div>
              <div className="mt-4 lg:mt-0">
                <div className="flex items-center space-x-2 text-sm text-gray-500">
                  <Ship className="h-4 w-4" />
                  <span>{readyToShipOrders.length} Ready to Ship</span>
                </div>
              </div>
            </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Orders Ready to Ship</h3>
            <p className="text-gray-600">No processed orders are currently ready for shipment.</p>
          </div>
        ) : (
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between space-y-4 lg:space-y-0">
                      ...
                      <div className="flex flex-col space-y-3 lg:w-64">
                        ...
                        <button
                          ...
                          className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-2 px-4 rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all font-medium text-sm shadow-lg"
                        >
                          Update Status
                        </button>
                      </div>
