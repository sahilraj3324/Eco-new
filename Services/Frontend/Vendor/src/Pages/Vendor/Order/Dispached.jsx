      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Dispatched Orders</h1>
                <p className="text-gray-600">Track orders that have been shipped and are in transit</p>
              </div>
              <div className="mt-4 lg:mt-0">
                <div className="flex items-center space-x-2 text-sm text-gray-500">
                  <PackageCheck className="h-4 w-4" />
                  <span>{shippedOrders.length} Dispatched Orders</span>
                </div>
              </div>
            </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Dispatched Orders</h3>
            <p className="text-gray-600">No orders have been dispatched yet.</p>
          </div>
        ) : (
