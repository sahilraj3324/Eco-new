...
import { Search, Filter, Package, Clock, AlertCircle, CheckCircle, Truck, XCircle, CheckCircle2 } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600">View orders that have been successfully delivered to customers</p>
              </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Delivered Orders</h3>
            <p className="text-gray-600">No orders have been delivered yet.</p>
          </div>
        ) : (
