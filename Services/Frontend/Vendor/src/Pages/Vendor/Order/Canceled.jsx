...
import { Search, Filter, Package, Clock, AlertCircle, CheckCircle, Truck, XCircle, Ban } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Cancelled Orders</h1>
                <p className="text-gray-600">View orders that have been cancelled by customers or vendors</p>
              </div>
              <div className="mt-4 lg:mt-0">
                <div className="flex items-center space-x-2 text-sm text-gray-500">
                  <Ban className="h-4 w-4" />
                  <span>{cancelledOrders.length} Cancelled Orders</span>
                </div>
              </div>
            </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Cancelled Orders</h3>
            <p className="text-gray-600">No orders have been cancelled.</p>
          </div>
        ) : (
                    ...
                    <div className="flex items-center space-x-6">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center space-x-6">
                          ...
                          <span className="text-lg font-bold text-gray-500 line-through">₹{order.unitPrice}</span>
