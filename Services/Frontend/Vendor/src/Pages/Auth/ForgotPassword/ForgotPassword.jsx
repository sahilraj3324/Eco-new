...
const ForgotPassword = () => {
  ...
  const [portal, setPortal] = useState('vendor'); // Will be set from localStorage
            ...
            <div className="rounded-md shadow-sm">
              <div>
                ...
                <input
                  ...
                  className="relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 focus:z-10 sm:text-sm"
            ...
            <div className="rounded-md shadow-sm -space-y-px">
              <div>
                ...
                <input
                  ...
                  className="relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 focus:z-10 sm:text-sm"
              ...
              <div>
                ...
                <input
                  ...
                  className="relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 focus:z-10 sm:text-sm"
