  ...
  return (
    <section className="px-4 py-8 relative">
      <div className="text-center mb-6">
        ...
        <div className="w-16 h-1 bg-gradient-to-r from-orange-500 to-orange-600 mx-auto"></div>
      </div>
      ...
      <div className="relative">
        ...
        >
          <ChevronLeft size={20} className="text-gray-600 group-hover:text-orange-600 transition-colors duration-200" />
        </button>
        ...
        <div ref={scrollRef} className="flex overflow-x-auto gap-4 px-8 scroll-smooth no-scrollbar" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          {loading ? (
            <div className="flex justify-center items-center w-full py-16">
              ...
              <span className="ml-3 text-gray-600 text-lg">Loading top products...</span>
            </div>
          ) : (
            products
            ...
            .map((product, index) => (
              <Link
                ...
                className="min-w-[220px] w-56 flex-shrink-0 bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group border border-gray-100 hover:border-orange-200"
              >
                ...
                <div className="p-4">
                  <h3 className="font-semibold text-gray-900 mb-2 text-sm line-clamp-2 group-hover:text-orange-600 transition-colors duration-200">
                    {product.name}
                  </h3>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="w-8 h-8 bg-orange-50 rounded-full flex items-center justify-center group-hover:bg-orange-100 transition-colors duration-200">
        ...
        >
          <ChevronRight size={20} className="text-gray-600 group-hover:text-orange-600 transition-colors duration-200" />
        </button>
      </div>
    </section>
  );
